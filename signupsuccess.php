...
<head>
    ...
    <link rel="stylesheet" href="styles/signupsuccess.css">
...
<body>
    ...
    <div class="popup">
        <div id="popup-upper">
                <div id="popup-upper-image-div">
                    <img src="./icons/success icon.png" class="success-icon">
                </div>
                <div class="success_text">Successfully Registered !</div>
        </div>
    
        <div id="popup-lower">
            <div class="success_text">Congratulations
                                    
            </div>
        <div id="continue-button-div"><button class="success_button" >
                Continue
            </div></div>
